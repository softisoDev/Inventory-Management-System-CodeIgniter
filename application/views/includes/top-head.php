<!-- fixed-top-->
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light navbar-shadow header-bg-color">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <!-- <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
                      <ul class="mega-dropdown-menu dropdown-menu row">
                        ...
                        <li class="col-md-3">
                          ...
                          <ul class="drilldown-menu sliding-menu" style="height: 214px;"><div class="sliding-menu-wrapper" style="width: 687.75px;"><ul id="menu-panel-ddj2g" class="menu-panel-root" style="width: 229.25px;">
                                <li>
                                  <a class="dropdown-item" href="layout-2-columns.html"><i class="ft-file"></i> Page layouts &amp; Templates</a>
                                </li>
                                <li><a href="#menu-panel-dvwux" class="nav-has-children dropdown-item"><i class="ft-align-left"></i> Multi level menu<i class="ft-arrow-right children-in"></i></a>
                                ...
                                <li>
                              ...
                              </ul><ul id="menu-panel-dvwux" class="menu-panel" style="width: 229.25px;"><a class="nav-has-parent back primary dropdown-item" href="#menu-panel-back"></a>
                                    <li><a class="dropdown-item" href="#"><i class="la la-bookmark-o"></i>  Second level</a></li>
                                    <li><a href="#menu-panel-e0llk" class="nav-has-children dropdown-item"><i class="la la-lemon-o"></i> Second level menu<i class="ft-arrow-right children-in"></i></a>
                                  ...
                                  </ul><ul id="menu-panel-e0llk" class="menu-panel" style="width: 229.25px;"><a class="nav-has-parent back primary dropdown-item" href="#menu-panel-back"></a>
                    ...
                    <!--<div class="nav-item">
                      <a class="navbar-brand">
                        <img class="brand-logo" alt="modern admin logo" src="app-assets/images/logo/sample_logo.png" width="130px">
                      </a>
                    </div>-->
                    <!-- <li class="nav-item">
                      <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo" src="app-assets/images/logo/sample_logo.png" width="105px">
                      </a>
                    </li> -->
                ...
                <ul class="nav navbar-nav float-right">
                    <!--<span style="margin-top:17px; margin-right:-97px; color: white; font-weight: bold">Naxçıvan</span>
                    <div class="nav-item navbar-brand">

                        <canvas id="clear-day" width="32" height="32"></canvas>

                        <span style="display: ruby-text-container; color: white;">+37 C </span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">Bildirişlər</span>
                                </h6>
                                <!--<span class="notification-tag badge badge-default badge-danger float-right m-0">5 New</span>-->
                            </li>
                            <li id="notificationContent" class="scrollable-container media-list w-100 ps-container ps-theme-dark" data-ps-id="02efef71-50ec-26af-3a6f-ab6bfc567f36">
                                <a href="javascript:void(0)">
                                    <div class="media text-center">Yoxdur</div>
                                </a>
                ...
                <span class="avatar avatar-online">
                  ...
                  <span class="user-name text-bold-700"><?php echo $_SESSION['user']->name; ?></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo base_url('logout'); ?>"><i class="ft-power"></i> Çıxış</a>
                        </div>
                    </li>
