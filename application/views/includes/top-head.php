        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100 ps-container ps-theme-dark" data-ps-id="02efef71-50ec-26af-3a6f-ab6bfc567f36">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100 ps-container ps-theme-dark" data-ps-id="78bb77c4-5f1b-c371-5cd7-eeda2c0e62ab">
                                <a href="javascript:void(0)">
                                    <div class="media">
                ...
                <span class="avatar avatar-online">
                  <img src="app-assets/images/portrait/small/admin-image.png" alt="avatar"><i></i>
                </span>
