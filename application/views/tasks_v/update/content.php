            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <?php if(!$result){echo '<h1 class="red">Məlumat Tapılmadı</h1>'; exit();} ?>

                        <form id="task-form" class="form" method="post" action="<?php echo base_url('tasks/update/').$task->ID; ?>">
                            <div class="form-body">
                                        ...
                                        <div class="input-group">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required readonly value="<?php echo $task->autoCode; ?>" id="auto-code" class="form-control border-primary" placeholder="Avtomatik Kod" name="auto-code">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="task-name" class="form-control border-primary" placeholder="Task Adı" name="task-name" required value="<?php echo $task->name; ?>">
                                                    <?php if(isset($form_error)): ?>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $task->startDate;?>" type="text" required id="startDate" class="form-control border-primary date" placeholder="Tarix" name="startDate">
                                                    <?php if(isset($form_error)): ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required id="endDate" class="form-control border-primary date" placeholder="Bitiş tarixi" name="endDate" value="<?php echo $task->endDate;?>">
                                                    <?php if(isset($form_error)): ?>
                                                        <span class="font-italic red font-weight-bold"><?php echo form_error('date'); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                        ...
                                        <div class="input-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required class="select2 form-control border-primary" name="machine" id="machine">
                                                        ...
                                                        foreach ($machines as $machine){ ?>
                                                            <?php if($task->machineID==$machine->ID){$avgMC = $machine->avgMC; } ?>
                                                            <option
                                                                    <?php echo ($task->machineID==$machine->ID)?"selected":"" ?>
                                                                    value="<?php echo $machine->ID; ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="machine-mc" class="form-control border-primary" placeholder="MC" name="machine-mc" required value="<?php echo $avgMC;?>">
                                                    <?php if(isset($form_error)): ?>
                                        ...
                                        <div class="input-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required class="select2 form-control border-primary" name="cigaretteType" id="cigaretteType" required>
                                                        ...
                                                        foreach ($cigarettes as $cigarette){
                                                            if($cigarette->ID==$task->ctID){$tobacAmount = $cigarette->expTobac;}
                                                            $selected = ($cigarette->ID==$task->ctID)?"selected":"";
                                                            echo '<option  
                                                            '.$selected.'
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1" step="0.01" readonly id="expTobac" class="form-control border-primary" placeholder="Tütün miqdarı" name="expTobac" required value="<?php echo $tobacAmount; ?>">
                                        ...
                                        <div class="input-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required class="select2 form-control border-primary" name="recipe" id="recipe" required>
                                                        ...
                                                        foreach ($recipes as $recipe){ ?>
                                                            <option
                                                                    <?php echo ($task->recipeID == $recipe->ID)?"selected":""?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control form-bordered" name="description" id="description"><?php echo $task->description;?></textarea>
                                                    <?php if(isset($form_error)): ?>
