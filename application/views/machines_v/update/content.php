            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('machines/update/').$items->ID; ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="machine-name" name="machine-name" class="form-control" required placeholder="Makina adı" value="<?php echo $items->name; ?>">
                                            <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" step="1" id="avg-mc" name="avg-mc" class="form-control" required placeholder="Ortalama MC" value="<?php echo $items->avgMC; ?>">
                                            <div>
                                                <?php if(isset($form_error)): ?>
                                                ...
                                                <?php
                                                    foreach ($cigaretteTypes as $ct){ ?>
                                                        <option
                                                                ...
                                                                <?php echo ($ct->ID == $items->cigTypeID)? "selected":""?>
                                                        >
                                                            <?php echo $ct->name; ?>
                                                        </option>
                                                <?php } ?>
