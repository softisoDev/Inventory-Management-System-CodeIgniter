            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <form class="form" method="post" action="<?php echo base_url('suppliers/save'); ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="supplier-name" class="form-control border-primary" placeholder="Tədarkçü Adı" name="supplier-name">
                                            <?php if(isset($form_error)): ?>
