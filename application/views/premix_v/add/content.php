            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <form class="form" method="post" action="<?php echo base_url('premixes/save'); ?>">
                            <div class="form-body">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="premix-name" class="form-control border-primary" placeholder="Adı" name="premix-name">
                                            <?php if(isset($form_error)): ?>
...
/*                                                foreach ($units as $unit){ */?>
                            ...
                            <h3 class="text-center">Premix İçeriği</h3>
                            <br/>
                                ...
                                <tr id="items-table-row-1">
                                    ...
                                    <td class="custom-product-td">
                                        <select name="product-unit[]" required  class="form-control custom-product-select product-unit" onchange="setUnitID2Input(this)">
                                            ...
                                            <?php
                                            foreach ($units as $unit){
                                                echo '<option data-id="'.$unit->ID.'" value="'.$unit->name.'">'.$unit->name.'</option>';
                                            }
                                            ?>
                                        </select>
                                        <input type="hidden" class="product-unit-db" name="product-unit-db[]" required>
                                    </td>
                                    <td class="custom-product-td">
                                        <fieldset>
                                            <div class="input-group">
                                                <input required type="text" name="product-quantity[]" class="form-control custom-product-input custom-touch-spin product-quantity general-touchspin sale-bill" data-bts-button-down-class="btn btn-info" data-bts-button-up-class="btn btn-info" onkeyup="calcRatio(this);" />
                                    ...
                                    <td class="custom-product-td">
                                        <fieldset>
                                            <div class="input-group">
                                                <input  readonly type="number" step="1" name="product-ratio[]" class="form-control custom-product-input product-ratio"/>
                                            </div>
                                        </fieldset>
                                    </td>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <strong>Cəm: </strong> <span id="premix-total-amount">0.00</span> <span id="premix-total-unit">kg</span>
                                    <input required type="hidden" name="premix-total-amount">
                                </div>
                            </div>
