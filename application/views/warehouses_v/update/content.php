            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('warehouses/update/').$warehouse->ID; ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="warehouse-name" class="form-control border-primary" placeholder="Adı" name="warehouse-name" required value="<?php echo $warehouse->name; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required onchange="fetchDepartment(this);" name="branch" class="form-control border-primary">
                                                ...
                                                <?php foreach ($branches as $branch){ ?>
                                                    <option
                                                            <?php echo ($warehouse->branchID==$branch->ID)?"selected":""; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="department" id="department" class="form-control border-primary">
                                                <?php foreach ($departments as $department){ ?>
                                                    <option
                                                            <?php echo ($warehouse->departmentID == $department->ID)?"selected":"";?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="personInCharge" class="form-control border-primary" placeholder="Məsul şəxs" name="personInCharge" required value="<?php echo $warehouse->personInCharge; ?>">
                                            <?php if(isset($form_error)): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control border-primary" name="description" rows="5" placeholder="Haqqında"><?php echo $warehouse->description; ?></textarea>
                                            <?php if(isset($form_error)): ?>
