            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <form class="form" method="post" action="<?php echo base_url('sales/save'); ?>">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="supplier">Müştəri (Firma/Şəxs)</label><span class="pull-right">+ Əlavə Et</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required class="select2 form-control border-primary" name="paymentType" id="paymentType">
                                                ...
                                                <?php foreach ($paymentTypes as $paymentType){ ?>
                                                        <option <?php echo ($paymentType->isDefault==1) ? "selected":""; ?>
                                                ...
                                                <table id="added-items-list" class="table full-width table-responsive table-bordered">
                                                    ...
                                                    <tr id="items-table-row-1">
                                                        ...
                                                        <td class="custom-product-td">
                                                            <fieldset>
                                                                <div class="input-group">
                                                                    <input onkeyup="calculateGrassTotal(this)" required type="text" name="product-quantity[]" class="form-control custom-product-input custom-touch-spin product-quantity general-touchspin sale-bill" data-bts-button-down-class="btn btn-info" data-bts-button-up-class="btn btn-info" />
                                                        ...
                                                        <td class="custom-product-td">
                                                            <fieldset>
                                                                <div class="input-group">
                                                                    <input onkeyup="calculateGrassTotal(this)" required type="text" name="product-price[]" class="form-control custom-product-input custom-touch-spin product-price general-touchspin" data-bts-button-down-class="btn btn-info" data-bts-button-up-class="btn btn-info" />
                                                                </div>
                                                            </fieldset>
                                                        </td>
                                                        <td class="custom-product-td">
                                                            <fieldset>
                                                                <div class="input-group">
                                                                    <input type="text" onkeyup="applyDiscount(this)" name="product-discount[]" class="form-control custom-product-input custom-touch-spin product-discount general-touchspin" data-bts-button-down-class="btn btn-info" data-bts-button-up-class="btn btn-info" />
                                                                </div>
                                                            </fieldset>
                                                        </td>
                                                        <td class="custom-product-td">
                            ...
                            <div class="col-md-12 text-right">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" onkeyup="calculateTotalDiscount()" name="generalDiscountValue" id="generalDiscountValue"  class="form-control custom-product-input custom-touch-spin general-touchspin" data-bts-button-down-class="btn btn-info" data-bts-button-up-class="btn btn-info" />
                                </div>
                                </div>
