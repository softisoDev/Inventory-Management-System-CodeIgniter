            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('cigarette_types/update/').$items->ID; ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="cigarette-name" name="cigarette-name" class="form-control" required placeholder="Adı" value="<?php echo $items->name; ?>">
                                            <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" step="1" id="expTobac" name="expTobac" class="form-control" required placeholder="Tütün Miqdarı" value="<?php echo $items->expTobac; ?>">
                                            <div>
                                                <?php if(isset($form_error)): ?>
                                                ...
                                                <?php
                                                    foreach ($units as $unit){ ?>
                                                            <option
                                                                    ...
                                                                    <?php echo ($items->unitID == $unit->ID)? "selected":"" ?>
                                                            >
                                                                <?php echo $unit->name; ?>
                                                            </option>
                                                <?php  }
                            ...
                            <div class="form-actions text-center">
                                <a href="<?php echo base_url('cigarette_types/update/').$items->ID; ?>" class="btn btn-warning mr-1">
