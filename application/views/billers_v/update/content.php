            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('billers/update/').$person->ID; ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly value="<?php echo $person->autoCode; ?>" id="auto-code" class="form-control border-primary" placeholder="Avtomatik Kod" name="auto-code" required >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="biller-name" class="form-control border-primary" placeholder="Fatura hazırlayan Adı&Soyadı" name="biller-name" required value="<?php echo $person->fullName; ?>">
                                            <?php if(isset($form_error)): ?>
