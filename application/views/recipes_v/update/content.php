            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('recipes/update/').$recipe->ID;; ?>">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="auto-code">Avtomatik Kod</label>
                                            <input type="text" readonly value="<?php echo $recipe->autoCode; ?>" id="auto-code"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="code" class="form-control border-primary" placeholder="Kodu" name="code" value="<?php echo $recipe->code; ?>">
                                            <?php if(isset($form_error)): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="recipe-title" class="form-control border-primary" placeholder="Adı" name="recipe-title" value="<?php echo $recipe->title; ?>">
                                            <?php if(isset($form_error)): ?>
