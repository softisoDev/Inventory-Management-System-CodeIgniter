            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('brands/update/').$brand->ID; ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="brand-name" class="form-control border-primary" placeholder="Adı" name="brand-name" required value="<?php echo $brand->name;?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control border-primary" name="description" rows="5" placeholder="Haqqında"><?php echo $brand->description; ?></textarea>
                                            <?php if(isset($form_error)): ?>
