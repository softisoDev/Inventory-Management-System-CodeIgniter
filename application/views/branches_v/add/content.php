            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <form class="form" method="post" action="<?php echo base_url('branches/save'); ?>">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="branch-name" class="form-control border-primary" placeholder="Adı" name="branch-name" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="city" class="form-control border-primary" placeholder="Şəhər" name="city" required>
                                            <?php if(isset($form_error)): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address" class="form-control border-primary" placeholder="Ünvanı" name="address">
                                            <?php if(isset($form_error)): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="mail" class="form-control border-primary" placeholder="Email" name="mail">
                                            <?php if(isset($form_error)): ?>
