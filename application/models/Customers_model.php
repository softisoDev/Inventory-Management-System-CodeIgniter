...
class Customers_model extends CI_Model{
    ...
    public function getDataTable(){
        ...
        $this->datatables->select('ID AS CID, autoCode, code, name, companyName, address, email, telephone, city, country, zipCode, special1, special2, createdAt, updatedAt, isActive');
